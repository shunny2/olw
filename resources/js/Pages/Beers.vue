        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <form @submit.prevent="submit">
                    <div class="grid sm:grid-cols-1 md:grid-cols-8 gap-4 flex-row items-end">
                        <div class="sm:col-span-8 md:col-span-4 lg:col-span-2">
                        ...
                        <div class="sm:col-span-8 md:col-span-4 lg:col-span-1">
